...
const getImageUrl = (path: string) => {
  if (!path) return "https://placehold.co/400x300/e2e8f0/1e293b?text=No+Image";
      ...
      <div className="p-4">
        <View className="flex-row justify-between items-start mb-1">
          ...
          <View className="flex-row items-center bg-yellow-50 px-2 py-1 rounded-lg">
            ...
            <Text className="ml-1 text-xs font-bold text-yellow-700">4.8</Text>
          </View>
        </View>
        ...
        <View className="flex-row justify-between items-center border-t border-gray-50 pt-3">
          ...
          <Text className="text-blue-600 font-bold text-base">
            ...
            <Text className="text-xs font-normal text-gray-500"> /orang</Text>
          </Text>
        </View>
      </div>
    </TouchableOpacity>
