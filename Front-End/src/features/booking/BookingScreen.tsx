    ...
    <View>
      ...
      <View className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm mb-6">
        <View className="flex-row justify-between mb-2">
          ...
          <Text className="font-bold text-gray-900">{locationName}</Text>
        </View>
        <View className="flex-row justify-between mb-2">
        ...
        <View className="flex-row justify-between mb-2">
          ...
          <Text className="font-bold text-gray-900">#{selectedSpot}</Text>
        </View>
      ...
      <PaymentMethod onSelect={(method: any) => setSelectedPayment(method)} />
    </View>
  );
    ...
    <View className="flex-1 bg-gray-50">
      ...
      <View className="absolute bottom-0 w-full bg-white p-5 border-t border-gray-100 shadow-2xl flex-row justify-between">
        ...
        {currentStep < 3 ? (
          ...
          >
            <Text className="font-bold text-white mr-2">Lanjut</Text>
          ...
          >
            {submitting ? (
              ...
              <>
                ...
                <Text className="font-bold text-white">Selesaikan</Text>
              </>
            )}
          </TouchableOpacity>
        )}
