      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className="flex-row px-5 mt-4 border-b border-gray-100">
          <TouchableOpacity
            ...
            className={`mr-6 pb-3 ${
              activeTab === "desc" ? "border-b-2 border-blue-600" : ""
            }`}
          >
            <Text
              className={`font-bold ${
                activeTab === "desc" ? "text-blue-600" : "text-gray-400"
              }`}
            >
              Deskripsi
            </Text>
          ...
          >
            <Text
              className={`font-bold ${
                activeTab === "review" ? "text-blue-600" : "text-gray-400"
              }`}
            >
                      ...
                      <View className="flex-row">
                        {[1, 2, 3, 4, 5].map((n) => (
                          <Star
                            key={n}
                            size={12}
                            fill={n <= rev.rating ? "#FBBF24" : "#E5E7EB"}
                            color="transparent"
                          />
                        ))}
                      </View>
                    </View>
                    <Text className="text-gray-600 text-sm">{rev.comment}</Text>
                  </View>
                ))
              )}
            </View>
